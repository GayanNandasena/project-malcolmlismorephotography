...
<div class="hero-section text-left h-auto flex flex-col justify-center items-start text-white mt-80" style="margin-left: 15%; margin-right: 15%;">
    ...
    <h2 class=" text-2xl tracking-widest mt-1">P H O T O G R A P H Y</h2>
    <p class=" text-xs tracking-widest mt-4">From the wild Scottish coast to your special day.Capturing memories that last a lifetime.</p>
</div>

<!-- social media buttons -->
<ul class="flex justify-center mt-32 space-x-5">
        <li>
...
<section class="about-me flex justify-around items-center text-black mt-80 bg-white h-auto pt-20 pb-20" style="padding-left: 15%; padding-right: 15%;">
    <div class="content px-16 ">
        <h1 class=" text-4xl font-bold tracking-widest">A B O U T</h1>
        <P class=" tracking-wide">
           <br> Hello! I’m Malcolm Lismore, a freelance photographer based on the stunning North West coast of Scotland.
           My passion lies in capturing the natural beauty of our surroundings and the special moments that make life unforgettable. 
        ...
        <div class="buttons flex gap-8  w-auto pt-4 text-sm xl:text-lg items-center xl:justify-start justify-center">
            <a href="about.php" class=" font-medium not-italic duration-500 text-sky-500 no-underline border border-sky-500 px-5 py-2.5 hover:text-white hover:bg-sky-500" >More Details</a>
            <a href="contact.php" class=" font-medium not-italic duration-500 text-sky-500 no-underline border border-sky-500 px-5 py-2.5 hover:text-white hover:bg-sky-500" >Contact Me</a>
        </div>
    </div>
...
<section class="services flex justify-around items-center text-black mt-auto bg-white h-auto pt-20 pb-20" style="padding-left: 15%; padding-right: 15%;">
    <div class="content ">
        ...
        <div class="grid grid-cols-4 gap-2 pt-16 pl-16 cursor-pointer h-auto">
            <div class=" relative">
                <img src="assets/images/service-grid-images/wedding.jpg" alt="Services" class="img object-cover duration-500 hover:opacity-50 h-[450px] w-[300px] ">
                <div class="text-center tracking-wide">
                    <h3 class=" font-semibold">WEDDINGS</h3>
                    <p>Capturing the elegance and emotion of your special day, preserving memories that last a lifetime.</p>
                </div>
            </div>
            <div class=" relative">
                <img src="assets/images/service-grid-images/portrait.png" alt="Services" class="img object-cover duration-500 hover:opacity-50 h-[450px] w-[300px] ">
                <div class="text-center tracking-wide">
                    <h3 class=" font-semibold">PORTRAIT</h3>
                    <p>Creating stunning portraits that showcase the unique character and personality of each individual.</p>
                </div>
            </div>
            <div class=" relative">
                <img src="assets/images/service-grid-images/event.jpg" alt="Services" class="img object-cover duration-500 hover:opacity-50 h-[450px] w-[300px] ">
                <div class="text-center tracking-wide">
                    <h3 class=" font-semibold">EVENTS</h3>
                    <p>Documenting the energy and excitement of your events, from corporate gatherings to personal celebrations.</p>
                </div>
            </div>
            <div class=" relative">
                <img src="assets/images/service-grid-images/nature.jpg" alt="Services" class="img object-cover duration-500 hover:opacity-50 h-[450px] w-[300px] ">
                <div class="text-center tracking-wide">
                    <h3 class=" font-semibold">NATURE</h3>
                    <p>Highlighting the beauty and splendor of nature through breathtaking landscape photography.</p>
                </div>
            </div>
        </div>
...
<!-- Portfolio highlights section -->
 <section class="portfolio-highlights flex justify-around items-center text-black mt-auto bg-white h-auto pt-20 pb-24" style="padding-left: 15%; padding-right: 15%;">
