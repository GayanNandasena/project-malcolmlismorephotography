    ...
    <div class="navbar flex flex-wrap items-center justify-between mx-auto pl-20 pr-12 pt-12 h-16">
        ...
        <ul class="links flex gap-8  w-auto">
            ...
            <li><a href="packages.php" class=" font-medium not-italic text-lg duration-500 text-sky-500 no-underline border border-sky-500 px-5 py-2.5 hover:text-white hover:scale-105 hover:bg-sky-500" >PACKAGES</a></li>
        </ul>
    ...
    <div class="dropdown_menu absolute right-8 top-20 h-0 w-80 bg-transparent backdrop-blur-lg rounded-3xl overflow-hidden transition-height text-white">
        ...
        <li class=" flex justify-center items-center p-3"><a href="packages.php" class=" duration-500 hover:tracking-widest hover:scale-105  text-sky-500 no-underline border border-sky-500 px-5 py-2.5 hover:text-white">PACKAGES</a></li>
    </div>
